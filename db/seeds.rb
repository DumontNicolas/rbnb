...
Game.create!(name: "Nemesis", description: "A sci-fi cooperation game... with a traitor", user_id: User.all.sample.id, category: "Coop", price: 15)
Game.create!(name: "Azul", description: "Be the first to build the perfect canvas for the king", user_id: User.all.sample.id, category: "Economy", price: 10)
Game.create!(name: "The Crew", description: "Your team crashed on a planet and you need to leave asap... Unless the planet manages to keep you there", user_id: User.all.sample.id, category: "Coop", price: 10)
Game.create!(name: "Gloomhaven", description: "Build a team and explore dungeons in this cooperative campaign-oriented game", user_id: User.all.sample.id, category: "Adventure", price: 20)
